  ...
  <material-form :title="$t('services.form_name')">
    <v-form ref="form">
      <v-container py-0>
        ...
        />
        <v-switch v-model="form.exclusivo" :label="$t('services.fields.exclusive')" />
        ...
        <material-button-group v-model="form.metraje" :label="$t('services.fields.metraje')">
        ...
        <app-transformer-form
          v-for="(transformer, i) in transformers" :key="i"
...
export default {
  ...
  methods: {
    ...
    createService: function () {
      ...
      const serviceUserForm = this.serviceUserForm.username ? this.serviceUserForm : null
